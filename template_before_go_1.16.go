...
<style>
	...
	* {
		font-family: "Fira Code", fallback_font, sans-serif;
		font-size: 1em;
	}


	/*Disable Force Dark Page in opera*/
	@media (prefers-color-scheme: dark) {
		/* Apply styles for dark color scheme */
		body {
...
/*func init() { //TODO: needs go:generate to replace
